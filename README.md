# DOLISTOCKRETURN FOR [DOLIBARR ERP & CRM](https://www.dolibarr.org)
...
Clone the repository in `$dolibarr_main_document_root_alt/dolistockreturn`

```shell
cd ....../custom
git clone git@github.com:gitlogin/dolistockreturn.git dolistockreturn
```
